<div>
    <table class="table table-bordered" id="products_table">
        <thead class="thead-dark">
            <tr>
                <th class="align-middle text-center" style="width: 35%;">Produk</th>
                <th class="align-middle text-center" style="width: 15%;">Kuantitas</th>
                <th class="align-middle text-center" style="width: 15%;">Harga</th>
                <th class="align-middle text-center" style="width: 20%;">Subtotal</th>
                <th class="align-middle text-center" style="width: 15%;">Tindakan</th>
            </tr>
        </thead>
